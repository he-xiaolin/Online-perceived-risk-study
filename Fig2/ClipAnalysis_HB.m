...
load(dir);
%% HB clip analysis %%%%%% Speed 80 100 120 km/h
clc
v_80=[];
for i=1:9
v_80 = [v_80; HB_PR(i).event_ratings];
end

v_100=[];
for i=10:18
v_100 = [v_100; HB_PR(i).event_ratings];
end

v_120=[];
for i=19:27
v_120 = [v_120; HB_PR(i).event_ratings];
end
...
% title('HB - Speed','FontName','FixedWidth');
...
%% HB clip analysis %%%%%% braking intensity -2 -5 -8 m/s^2
clc
BI_2=[];
for i=[1:3,10:12,19:21]
BI_2 = [BI_2; HB_PR(i).event_ratings];
end

BI_5=[];
for i=[4:6, 13:15, 22:24]
BI_5 = [BI_5; HB_PR(i).event_ratings];
end

BI_8=[];
for i=[7:9, 16:18,25:27]
BI_8 = [BI_8; HB_PR(i).event_ratings];
end
...
% title('HB - Braking Intensity','FontName','FixedWidth');
ylabel('Perceived risk','FontSize',20);
set(get(gca,'XLabel'),'FontSize',20);
...
%% HB clip analysis %%%%%% Distance 
clc
idx=[1 4 7 10 13 16 19 22 25];
d_5=[];
for i=idx
d_5 = [d_5; HB_PR(i).event_ratings];
end

d_15=[];
for i=idx+1
d_15 = [d_15; HB_PR(i).event_ratings];
end

d_25=[];
for i=idx+2
d_25 = [d_25; HB_PR(i).event_ratings];
end
...
% title('HB - Distance','FontName','FixedWidth');
ylabel('Perceived risk','FontSize',20);
set(get(gca,'XLabel'),'FontSize',20);
