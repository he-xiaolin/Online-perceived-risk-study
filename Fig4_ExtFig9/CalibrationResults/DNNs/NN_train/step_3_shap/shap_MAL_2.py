...
def shap_cal(model_name, data, K, event_id, event_duration, event_numb, feature_names):
    ...
    with open('MAL_2/shap_data_all_random.pkl', 'rb') as file:
...
path_data = '../4-BNN_prediction/data/MAL_feature_reg_2.npy'
data = np.load(path_data)
K = 1500  # sampling K points from all data
event_id = 1
event_duration = 361
path_best_weight = '../4-BNN_prediction/models/20231219_2222/MAL_2/best_model_MAL_2.pth'
