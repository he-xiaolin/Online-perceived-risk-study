...
File_name =append('processed_feature_v4/MAL_1/regression_input/MAL_1_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
for i = 1:12
    ...
    File_name =append('processed_feature_v4/MAL_1/regression_label/MAL_1_rating_',num2str(i,'%02d'),'.mat');
