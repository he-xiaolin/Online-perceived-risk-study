...
mkdir('processed_feature_v5/LC_2/regression_input');
mkdir('processed_feature_v5/LC_2/regression_label');
data_ = load(pt);
data = data_.LC;
...
File_name =append('processed_feature_v5/LC_2/regression_input/LC_2_input_',num2str(i,'%02d'),'.mat');
...
for i = 13:18
    ...
    File_name =append('processed_feature_v5/LC_2/regression_label/LC_2_rating_',num2str(i,'%02d'),'.mat');
