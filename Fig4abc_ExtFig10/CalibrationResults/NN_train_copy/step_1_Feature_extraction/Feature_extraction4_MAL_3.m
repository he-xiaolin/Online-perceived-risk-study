...
File_name =append('processed_feature_v4/MAL_3/regression_input/MAL_3_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
for i = 19:24
    ...
    File_name =append('processed_feature_v4/MAL_3/regression_label/MAL_3_rating_',num2str(i,'%02d'),'.mat');
