...
Input_Dic_name = '../../3-Feature_extraction/processed_feature_v4/MAL_3/regression_input/'
Label_Dic_name = '../../3-Feature_extraction/processed_feature_v4/MAL_3/regression_label/'
...
for ind, File_name in enumerate(Input_File_name_list):  # event files   1-27
    ...
    Label = np.transpose(mat_file_label['MAL_3_rating'])
...
np.save('../data/MAL_feature_reg_3.npy',MAL_feature_reg)
