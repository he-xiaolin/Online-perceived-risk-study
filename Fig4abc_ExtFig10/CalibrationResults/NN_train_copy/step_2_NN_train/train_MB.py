...
from modules.training_function import train_mc_dropout  # train_mc_dropout is defined in modules/training_function.py
...
parser.add_argument('--experiment_index', type=str, default='202411-complete_data',
