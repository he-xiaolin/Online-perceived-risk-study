...
def shap_cal(model_name, data, K, event_id, event_duration, event_numb, feature_names):
    ...
    with open('HB/shap_data_all_random.pkl', 'rb') as file:
...
path_data = '../4-BNN_prediction/data/HB_feature_reg.npy'
data = np.load(path_data)
K = 1500  # sampling K points from all data
event_id = 1
event_duration = 301  # 301
path_best_weight = '../4-BNN_prediction/models/20231219_2222/HB/best_model_HB.pth'
