...
delta_y=data(i).delta_y;
    ...
    File_name =append('processed_feature/MAL_1/regression_input/MAL_input_',num2str(i,'%02d'),'.mat');
...
for i = 1:12
    ...
    File_name =append('processed_feature/MAL_1/regression_label/MAL_rating_',num2str(i,'%02d'),'.mat');
