...
File_name =append('processed_feature_v4/HB/regression_input/HB_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
for i = 1:27
    ...
    File_name =append('processed_feature_v4/HB/regression_label/HB_rating_',num2str(i,'%02d'),'.mat');
