...
File_name =append('processed_feature_v3/MAL_2/regression_input/MAL_2_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'x_s', 'x_n', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
...
for i = 13:18
    ...
    File_name =append('processed_feature_v3/MAL_2/regression_label/MAL_2_rating_',num2str(i,'%02d'),'.mat');
