...
File_name =append('processed_feature_v3/MB/regression_input/MB_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'x_s', 'x_n', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
...
for i = 1:27
    ...
    File_name =append('processed_feature_v3/MB/regression_label/MB_rating_',num2str(i,'%02d'),'.mat');
